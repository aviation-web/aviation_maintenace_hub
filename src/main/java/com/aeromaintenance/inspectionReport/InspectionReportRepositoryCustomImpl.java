...
public class InspectionReportRepositoryCustomImpl implements InspectionReportRepositoryCustom {
	...
	@Override
	public int updateInHistoryTable(InspectionReportDto form) {
		Query query = entityManager.createNativeQuery(
			    "UPDATE inspection_report_history SET " +
			    "report_no = ?, part_desc = ?, part_number = ?, batch_number_observation = ?, " +
			    "purchase_order_no = ?, qty = ?, qty_receive = ?, supplier_name = ?, `date` = ?, " +
			    "maker_date = ?, checker_date = ?, date_of_manufacturing_observation = ?, " +
			    "maker_user_id = ?, maker_user_name = ?, checker_user_id = ?, checker_user_name = ?, " +
			    "user_role = ?, user_action = ?, document_observation = ?, invoice_observation = ?, " +
			    "manufacturer_cert_observation = ?, supplier_cert_observation = ?, tds_observation = ?, " +
			    "specification_observation = ?, material_condition_observation = ?, self_life_observation = ?, " +
			    "full_traceability_observation = ?, lot_accepted = ?, remark = ?, " +
			    "date_of_expiry_observation = ?, document_path = ? " +
	    ...
	    query.setParameter(28, form.getLotAccepted());
	    query.setParameter(29, form.getRemark());
	    query.setParameter(30, form.getDateOfExpiryObservation());
	    query.setParameter(31, form.getDocumentPath());
	    query.setParameter(32, form.getInspectionReportId());
