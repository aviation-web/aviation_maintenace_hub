...
public interface InspectionReportRepository extends JpaRepository<InspectionReport, Long> {
    ...
    @Query(value = "SELECT inspection_report_id, part_number, part_desc, purchase_order_no, supplier_name, report_no, date, qty,invoice_obervation, manufacturer_cert_observation, "+
    ...
    " specification_observation, document_observation, lot_accepted, remark, maker_user_name, maker_date, checker_user_name, checker_date "+
